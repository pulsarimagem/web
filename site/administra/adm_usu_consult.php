...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE usuarios SET login=%s, senha=%s, index_inc=%s, index_alt=%s, index_del=%s, temas=%s, pal_chave=%s, home=%s, ensaios=%s, cotacao=%s, cad_clientes=%s, cad_usuarios=%s, fotografos=%s, ftp=%s, enviar_msg=%s, rel_download=%s, download=%s, relatorios=%s, fotos_idx=%s, email=%s WHERE id_user=%s",
                       ...
                       GetSQLValueString(isset($_POST['fotos_idx']) ? "true" : "", "defined","1","0"),
...
<form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  ...
  <table width="308" border="1" cellpadding="3" cellspacing="0" bordercolor="#666666">
    ...
    <tr>
      <td><input <?php if (!(strcmp($row_usuarios['fotos_idx'],1))) {echo "checked";} ?> name="fotos_idx" type="checkbox" id="fotos_idx" value="1"></td>
      <td class="style18"><div align="center">Fotos sem indexação</div></td>
    </tr>
  </table>
  <br>
