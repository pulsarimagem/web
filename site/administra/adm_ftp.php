...
<table width="100%"  border="0" cellpadding="5" cellspacing="0" bgcolor="#FF9900">
   <tr>
     <td class="style1">pulsarimagens.com.br<br>
         tela do administrador</td><td><div align="right">
...
<p><br>
    <span class="style4"><a href="adm_ftp_inc.php">1. Criar diret&oacute;rio</a><br>
    <br>
    <a href="adm_ftp_tmp.php">1b. Criar diret&oacute;rio tempor&aacute;rio (para usuários sem login)</a><br>
    <br>
    <a href="adm_ftp_files.php">2. Upload/Exclus&atilde;o de imagens</a><br>
    <br>
    <a href="adm_ftp_email.php">3. Enviar Email</a><br>
    <br>
    <a href="adm_ftp_del.php">4. Remover diret&oacute;rio</a><br>
    <br>
    <a href="adm_ftp_log.php">5. Log Download </a><br>
  </span><br>
</p>
</body>
</html>
