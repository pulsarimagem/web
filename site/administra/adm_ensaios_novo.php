...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO ensaios (titulo, texto) VALUES (%s, %s)",
...
self.opener.location = '<?php echo $_POST['link']; ?>/adm_ensaios.php';window.close();
</script>
<?php 
}
?>
...
<table width="600" border="0" cellpadding="0" cellspacing="0">
  <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
    <tr>
      <td width="100"><span class="style9">T&iacute;tulo:</span></td>
      <td><input name="textfield" type="text" size="60">                </td>
    </tr>
    <tr>
      <td width="100"><span class="style9">Texto:</span></td>
