...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO usuarios (login, senha, index_inc, index_alt, index_del, temas, pal_chave, home, ensaios, cotacao, cad_clientes, cad_usuarios, fotografos, ftp, enviar_msg, rel_download, relatorios, fotos_idx) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<table width="308" border="1" cellpadding="3" cellspacing="0" bordercolor="#666666">
  ...
  <tr>
    <td><input name="fotos_idx" type="checkbox" id="fotos_idx" value="checkbox"></td>
