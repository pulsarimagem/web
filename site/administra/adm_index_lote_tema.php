...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1") && ($_POST["Id1"] > 0)) {
  $insertSQL = sprintf("INSERT INTO rel_fotos_temas (id_foto, id_tema) SELECT Id_Foto as id_foto, %s as id_tema from Fotos where tombo in (%s)",
...
<title>Incluir Tema em Lote</title>
<style type="text/css">
<!--
.style1 {
