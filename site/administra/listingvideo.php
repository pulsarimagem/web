...
if(isset($_GET['action'])) {
	...
	if($action=="Finalizar") {
		...
		mysql_select_db($database_pulsar, $pulsar);
		$update_status = mysql_query($query_update_status, $pulsar) or die(mysql_error());
		header("location: listingvideo.php");
	}		
}
...
jQuery(document).ready(function() {
	...
	function () {
		...
		$(this).children("div.box_video").show();
		
	},
	function () {
		$(this).children("a.icon").removeClass("icon-hover");
		$(this).children("div.box_video").hide();
	}
	);	
});
</script>
		...
		<div class="resultado">
			<form name="listing_opts" action="listingvideo.php" method="get">		
				<div class="title">
					...
					<div class="p">
<?php include("../br/part_listing_options.php")?>
						<div class="clear"></div>
					</div>
					<div class="clear"></div>
				</div>
