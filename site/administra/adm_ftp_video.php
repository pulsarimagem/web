...
$query_usos = "select
    		...
    		where uso.status != 0 and uso.contrato = 'V'
    		order by tipo, utilizacao,formato,valor";
...
$(document).ready(function() {
	$(".uso").change(function()	{
		var id=$(this).val();
		var dataString = 'action=tamanho&contrato=V&id_uso='+ id;
...
<form id="form1" name="form1" method="post" action="adm_ftp_video2.php">
