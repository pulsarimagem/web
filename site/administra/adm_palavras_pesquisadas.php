...
<table width="600" border="1" cellspacing="0" cellpadding="0">
  ...
  <?php do { ?>
  <tr>
    <td class="style4"><a href="../br/listing.php?so_pc=<?php echo $row_palavra_chave['pal']; ?>&pc_action=Ir&type=pc&tipo=inc_pc.php&pc_action=Ir" target="_blank"><?php echo $row_palavra_chave['pal']; ?></a></td>
