...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1") && ($totalRows_pal_chave != 0)) {
  ...
  $insertSQL = sprintf("DELETE FROM rel_fotos_pal_ch WHERE id_palavra_chave = %s AND id_foto in (SELECT Id_Foto from Fotos where tombo in (%s))",
...
<title>Excluir Palavra Chave em Lote</title>
<style type="text/css">
<!--
.style1 {
