...
***************************************************************************-->
        ...
        <head>
                ...
                <?php
                        ...
                        if ( !isset($_GET['jpeg_fname']) ||  $_GET['jpeg_fname'] == "" )
                        {
                        ...
                        // Output the title
                        echo "<title>Metadata details for $orig</title>";

                        // Retrieve the header information
                        $jpeg_header_data = get_jpeg_header_data( $orig );
