...
<div class="main size960">
  ...
  <div class="primeirapagina">
	<div class="minhasimagens">
     <h2 class="titulo-pagina">Download history</h2>
            ...
            <div class="minhasimages-historico">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <thead>
                        <tr>
                            <td colspan="2">Monthly download report</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
							<td width="120"><strong>Month/Year:</strong></td>
                            <td>
...
?>
                        ...
                        <tr>
							<td><strong>Total donwloaded:</strong></td>
...
<?php do {?>                    
                        <tr>
                            ...
                            <td class="sobre">
                                ...
                                Code: <strong><?php echo $row_fotos_download['tombo']; ?></strong><br/>
                                Author: <strong><?php echo $row_fotos_download['Nome_Fotografo']; ?></strong><br/>
                                Date of Download: <strong><?php echo makeDateTime($row_fotos_download['data_hora'], 'd/m/y'); ?></strong><br/>
                                Name: <strong><?php echo $row_fotos_download['usuario']; ?></strong><br/>
...
<                               Tiragem: <strong><?php echo $row_fotos_download['tiragem']; ?></strong><br/> -->
                                Project: <strong><?php echo $row_fotos_download['projeto']; ?></strong><br/>
...
<?php } ?>
                                Comments: <strong><?php echo $row_fotos_download['obs']; ?></strong><br/>                            </td>
                        </tr>
