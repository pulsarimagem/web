...
<?php 
do { 
	$isVideo = isVideo($row_mais_novas['tombo']);
?>
					<li>
						<a href="details.php?tombo=<?php echo $row_mais_novas['tombo']."&search=lastadd"; ?>">
							<img <?php if($isVideo) { ?>src="<?php echo $cloud_server?>Videos/thumbs/<?php echo $row_mais_novas['tombo']; ?>_3s.jpg"<?php } else { ?>src="<?php echo "http://www.pulsarimagens.com.br/" //$homeurl; ?>bancoImagens/<?php echo $row_mais_novas['tombo']; ?>p.jpg" <?php } ?> title="" onMouseover="ddrivetip('<?php echo $row_mais_novas['assunto_principal']; ?><?php 
