<div class="action-image">
  <ul>
    <li class="impressao"><a href="historicodownload_print.php?mes_ano=<?php echo trim($mes)."/".trim($ano)?>" title="Versão impressão">Print version</a></li>
    <li class="voltar"><a href="primeirapagina.php" title="Voltar">Back</a></li>
  </ul>
  <br />
<!--   
  <ul>
    <li class="meucadastro"><a href="cadastro.php" title="Meu cadastro">Meu cadastro</a></li>
