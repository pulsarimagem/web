    ...
    <div class="form-search">
      <form action="listing.php" method="get" id="buscaTopo" name="busca_topo">
        <div class="input-text">
          <input type="text" class="text" name="query" placeholder="Keyword or Code" />
        </div>
        <div class="opcoes input-select">
          <div class="superSelect">
            <div class="label">
              <div class="default_value">All </div>
              <span class="arrow"></span>
            </div>
            <div class="content">
              <ul class="wrapper-inputs">
                <li><label><input name="filtro[]" type="checkbox" value="foto" title="Photo" <?php if(isset($show_foto)&&$show_foto) echo "checked"?>/> Photo</label></li>
                <li class="last"><label><input name="filtro[]" type="checkbox" value="video" title="Video" <?php if(isset($show_video)&&$show_video) echo "checked"?>/> Video</label></li>
              </ul>
            </div>
          </div>
        </div>  
        <input type="submit" value="Search" class="button" name="pc_action">
...
<?php include("menu_nossos_temas.php")?>        
    ...
    <div class="footer-form">
      <a class="adv" href="buscaavancada.php">Advanced search</a>
    </div>
  </div>
  <!-- SuperBusca -->
