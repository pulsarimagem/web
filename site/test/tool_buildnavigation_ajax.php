...
function buildNavigation($actual, $maxRows_retorno, $totalRows_query, $display_qty = 3, $separator = " ... ") {
    ...
    if($pages_qty > 1) {
	    if($actual > 0) {
	    	$precedente = $actual - 1;
	    	$firstArray = "<a href=\"#\" class=\"ant nav_page_num\" id=\"nav_page-$precedente\">&laquo; ".BUILDNAV_ANTERIOR."</a>";
			$debug .= "First! ";
	    }
	    else {
	    	$firstArray = "<a href=\"#\" class=\"ant_empty\"></a>";
	    }
	    
	    if ($actual < $pages_qty-1) {
	    	$successivo = $actual + 1;
	    	$lastArray = "<a href=\"#\" class=\"pro nav_page_num\" id=\"nav_page-$successivo\">".BUILDNAV_PROXIMA." &raquo;</a>";
			$debug .= "Last! ";
	    }
	    else {
	    	$lastArray = "<a href=\"#\" class=\"pro_empty\"></a>";
	    }
	    ...
	    for($a = 0; $a < $pages_qty; $a++) {
	    	...
	    	if($a == 0) {
	    		if($a ==  $actual)
					$pagesArray .= "<div class=\"pag\"><a href=\"#\" class=\"nav_page_num\" id=\"nav_page-$a\"><strong>1</strong></a>";
				else 
					$pagesArray .= "<div class=\"pag\"><a href=\"#\" class=\"nav_page_num\" id=\"nav_page-$a\">1</a>";
	    	}
	    	else if(($a < $display_qty + 2) && $actual < $display_qty) {
				$page = $a + 1;
	    		if($a ==  $actual)
					$pagesArray .= "<a href=\"#\" class=\"nav_page_num\" id=\"nav_page-$a\"><strong>$page</strong></a>";
	    		else 
					$pagesArray .= "<a href=\"#\" class=\"nav_page_num\" id=\"nav_page-$a\">$page</a>";
			}
	    	...
	    	$firstArray = "<a href=\"#\" class=\"ant_empty\"></a>";
	    	$lastArray = "<a href=\"#\" class=\"pro_empty\"></a>";
			$pagesArray = "<div class=\"pag_empty\"><a href=\"#\"></a>";
