...
<body style="margin: 0; padding: 0; "marginheight="0" topmargin="0" marginwidth="0" leftmargin="0">
  <p style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; text-align:center; margin: 0; color:#666666; font-weight: normal;">Caso n&atilde;o consiga visualizar esse e-mail <a href="http://www.pulsarimagens.com.br/tool_ver_email.php?email_id='.$email_id.'&tipo=foto" target="_blank">clique aqui</a></p>
...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="1" bgcolor="#999999"></td>
                    ...
                    <tr>
                      <td><p style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; text-align:left; margin: 0; padding-left:30px; color:#666666; font-weight: normal;">Clicando na foto &eacute; poss&iacute;vel ampli&aacute;-la.</p></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td><table width="200" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                          <td><p align="center"><a href="http://www.pulsarimagens.com.br/br/details.php?tombo='.($email_tombo).'" target="_blank"><img src="http://www.pulsarimagens.com.br/bancoImagens/'.$email_tombo.'p.jpg" hspace="5" border="0" class="imgborder"></a></p></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                        </tr>
