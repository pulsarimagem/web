...
<title>Pulsar Imagens | Banco de imagens do Brasil</title>
...
<div class="home-welcome">
	<img src="<?php echo $home_img;?>" class="big" onclick="document.location.href='details.php?tombo=<?php echo $home_tombo?>'" style="cursor: pointer;"/>
<!--	<div class="busca">
  		<h2>Busca:</h2>
