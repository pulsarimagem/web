...
<!--  												<li class="adicionar"><a href="#">Adicionar as minhas imagens</a></li>-->
											...
											<div class="details">
											  <ul>
												...
												<li class="uso show_uso" id="showuso_<?php echo $id?>"><span class="label">Uso:</span> <?php echo ($subtotal==0?"Clique aqui para adicionar o uso e o pre&ccedil;o nessa imagem":translate_iduso($id_uso,$lingua,$sig))?></li>
