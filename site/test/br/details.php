...
<!-- 			<h2><?php echo $row_dados_foto['assunto_principal']; ?></h2> -->
			<h2><span class="label">Código:</span> <?php echo $row_dados_foto['tombo']; ?></h2>
...
<?php //} ?>
        ...
        <div class="action-image">
          <ul>
<!--             <li class="cotacao"><a href="#ancora_uso" title="Cotação">Calcular Preço</a></li> -->
          	<li class="cotacao"><a href="<?php print $_SESSION['last_detail']; ?>&cotar=true" title="Cotação">Cotação</a></li>
<?php if($logged) { ?>
<!--             <li class="carrinho"><a href="ecommerce/action.php?add=<?php echo $tombo;?>" title="Adicionar ao carrinho">Adicionar ao carrinho</a></li> -->
<?php } ?>
            <li class="minhas-pastas"><a href="details.php?tombo=<?php echo $tombo;?>&search=<?php echo $search;?>&total_foto=<?php echo $total_foto;?>&ordem_foto=<?php echo $ordem_foto;?>&page_num=<?php echo $page_num;?>&addimg=true" title="Adicionar às Minhas Pastas">Adicionar às Minhas Pastas</a></li>
<?php if($isVideo) {?>
            <li class="salvar"><a href="<?php echo $cloud_server."/Videos/previews/".$row_dados_foto['tombo']."_$res_pop.flv";?>" title="Salvar em baixa resolução">Salvar em baixa resolução</a></li>
<?php } else { ?>
            <li class="salvar"><a href="../tool_downloader.php?tombo=<?php echo $row_dados_foto['tombo'];?>" title="Salvar em baixa resolução">Salvar em baixa resolução</a></li>
<?php } ?>
      ...
      <div class="clear"></div>
			<div class="info">
				<div class="infA">
          <p><span class="label">Código:</span> <?php echo $detail_tombo; ?></p>
...
<?php if($row_dados_foto['direito_img'] != 0 && false) { ?>                
                ...
                <div class="infA">
                <p><span class="label">Informações sobre o uso da mídia:</span></p>
                <p><span class="label">Direito de propriedade:</span>
<?php 
if($row_dados_foto['direito_img'] == 1) echo "Autorizado";
else if($row_dados_foto['direito_img'] == 2) echo "Autorizado - ACRÉSCIMO DE 100% SOBRE O VALOR DE TABELA";
else if($row_dados_foto['direito_img'] == 3) echo "Não autorizado";
else echo "";
?>
				</p>
				</div>
...
else if($row_dados_foto['direito_img'] == 2) echo "<p><span class=\"label\">OBS:</span> USO DE IMAGEM AUTORIZADO - ACRÉSCIMO DE 100% SOBRE O VALOR DE TABELA</p>"; 
?>
				</div>
				<div class="clear divisor"></div>
				<div class="infC">
