...
$contratoArr = isset($_POST["contratos"])?$_POST["contratos"]:(isset($_GET["contratos"])?$_GET["contratos"]:exit("Nenhum contrato selecionado para impressão!"));
$cnt = 0;

foreach ($contratoArr as $id_contrato) {
...
<table width="100%" style="margin-top:0px;">
	...
	<tr><td width="12%">&nbsp;</td><td><?php echo $cnpj?></td></tr>
	<tr><td colspan="2" height="5px;"></td></tr>
...
<table align="center" width="100%">
	...
	?>
		<tr id="anexo"><td align="center" id="anexo"><?php echo $row_objRS7["CODIGO"]?>&nbsp;</td><td align="center" id="anexo"><?php echo $row_objRS9["NOME"]?></td><td align="left" id="assunto"><div class="nobreak"><?php echo $row_objRS7["ASSUNTO"]?></div></td><td align="center" id="anexo">R$ <?php echo FormatNumber((float)fixnumber($row_objRS7["VALOR"]),2)?></td><td align="center" id="anexo">R$ <?php echo FormatNumber((float)fixnumber($row_objRS7["DESCONTO"]),2)?></td>
