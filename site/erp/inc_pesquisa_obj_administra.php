			...
			if($ordem == "recente") {
				...
				foreach($this->pesquisas as $pesquisa) {
					foreach($pesquisa->arrPalavras as $palavra=>$idioma) {
						...
						$palavra = str_ireplace("e", "[eËÍÎÈ]", $palavra);
						$palavra = str_ireplace("i", "[iÏÓÔÌ]", $palavra);
						$palavra = str_ireplace("o", "[oÚÙˆıÛ]", $palavra);
						$palavra = str_ireplace("u", "[u˘˚¸˙]", $palavra);
						$palavra = str_ireplace("c", "[cÁ]", $palavra);
						$palavra = str_ireplace("n", "[nÒ]", $palavra);
...
echo "Palavra o: $palavra<br>";
						...
						$palavra = str_ireplace("^", "[a‡‚‰„·oÚÙˆıÛ]", $palavra);
						$palavra = $palavra."s?";
