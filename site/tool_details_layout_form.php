 ...
 */	
			...
			$subject = "Layout baixado: $file\n";
			$message = "[Layout] Foi feito o download do layout $file por ".$_POST['nome'].", usuário ".$row_top_login['nome']." em ".date("d-m-Y H:i:s", strtotime('now'))."\n";
