...
<div class="block-busca">
	<form action="listing.php" method="get" id="form_block_busca">
		<h3><b>You searched</b></h3>
	    <div class="block-lateral1 block">
	        <ul>
	            <li>
	                <p style="font-style:oblique; font-weight:bold">Keywords</p>
	            </li>
	            <li>
<?php 
$search_cnt = 0;
...
<?php 
				if($filtro == "id_tema") {
					echo translate_idtema($val,$pulsar,$lingua);
				}
				else if($filtro == "id_autor") {
...
<?php } ?>
	            ...
	            <li>
	                <span class="limpar-busca">
	                    <a href="listing.php?clear=true">Clear all</a>
	                </span>
	            </li>
	        </ul>
	    ...
	    <div class="block-lateral2 block">
	        ...
	        <a href="buscaavancada.php">Advanced search</a>
	        </span>               
	    </div>
	    ...
	    <span class="linha"></span>
      	...
      	<div class="block-lateral5 block">
	        ...
	        <select name="ano" class="select" id="select_data">
		        <option value="" <?php if(!isset($_GET['ano'])) echo "selected";?>>All</option>
<?php 
...
?>		        
	        ...
	        <select name="data_tipo" class="select">
		        <option value="depois" <?php if(isset($_GET['data_tipo'])&&$_GET['data_tipo'] == "depois") echo "selected"?>>Exact date</option>
		        <option value="exata" <?php if(isset($_GET['data_tipo'])&&$_GET['data_tipo'] == "exata") echo "selected"?>>and before</option>
                <option value="antes" <?php if(isset($_GET['data_tipo'])&&$_GET['data_tipo'] == "antes") echo "selected"?>>and after</option>
        	</select>
      	</div>
	    ...
	    <div class="block-lateral3 block">
	        ...
	        <ul>
	        	<li>
	            	<label><input type="checkbox" name="filtro[]" value="foto" class="submit_onclick" <?php if($show_foto) echo "checked"?>/><span class="foto">Photo</span></label>
	            </li>
				<li>
	            	<label><input type="checkbox" name="filtro[]" value="video" class="submit_onclick" <?php if($show_video) echo "checked"?>/><span class="video">Video</span></label>
	            </li>
	        	<div class="clear"></div>
	        </ul>
	    </div>
  ...
  <form name="form_buscaimagens" method="get" action="listing.php" id="form_buscaimagens">
    <ul>
      ...
      <li>
        ...
        <a href="buscaavancada.php" class="badv">Ir para Busca Avançada</a>
        <div class="clear"></div>
      </li>
    </ul>
  </form><?php */?>
