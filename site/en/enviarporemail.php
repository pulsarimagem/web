	...
	<div class="grid-center">
		<form name="form1" method="get" action="enviarporemail.php">
			<div class="solicitarcotacao">
				<h2>Send via e-mail</h2>
<?php if($has_error) {?>
				<div class="error-msg">You need to fill the highlighted fields.</div>
<?php } ?>
				<label>Name:</label>
				...
				<h2 style="padding-top: 16px;">Selectec media:</h2>
				<ul>
<?php do { ?>
					<li>
...
<?php }?>
					...
					<input name="action" type="submit" value="Send" class="button" />
