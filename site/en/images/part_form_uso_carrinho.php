										  ...
										  <td>
											...
											<div class="descricao">
											  <ul>
												...
												<li class="uso show_uso" id="showuso_<?php echo $id?>"><span class="label">Usage description:</span> <?php echo ($subtotal==0?"Clique aqui para adicionar o uso e o pre&ccedil;o nessa imagem":$id_uso)?></li>
