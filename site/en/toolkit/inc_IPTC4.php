...
WHERE   
	(Fotos.tombo LIKE '%s' AND Pal_Chave_en IS NOT NULL) 
ORDER BY
	Pal_Chave_en
", $tombo );
...
$IPTCtitle = translateText($row_dados_foto ['assunto_principal']);
$IPTCcreator = $row_dados_foto ['nome_fotografo']; 
$IPTCbylinetitle = $tombo;
$IPTCdescription = translateText($row_dados_foto ['assunto_principal']);
$IPTClocation = $local;
