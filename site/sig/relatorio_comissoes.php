...
// 					if($row_objRsContratos["ID"] == 12603)
// 						echo $row_objRsContratos['VALOR_TOTAL'] ." -> ".fixnumber($row_objRsContratos['VALOR_TOTAL']);
...
//						$pulsar_comissao = ((($row_objRsContratos["VALOR_TOTAL"] - $impvalor) - $cliente_comissao) - $indio_comissao)*0.45;
						$pulsar_comissao = ((($row_objRsContratos["VALOR_TOTAL"] - $impvalor) - $cliente_comissao) - $indio_comissao)*0.50;
						$total_indio = $total_indio + $pulsar_comissao;
					}
					else {
//						$pulsar_comissao = (($row_objRsContratos["VALOR_TOTAL"] - $impvalor) - $cliente_comissao) / 2;
//						$pulsar_comissao = ((($row_objRsContratos["VALOR_TOTAL"] - $impvalor) - $cliente_comissao))*0.45;
						$pulsar_comissao = ((($row_objRsContratos["VALOR_TOTAL"] - $impvalor) - $cliente_comissao))*0.50;
					}
			...
			?>
					...
					<tr>
						...
						<td id="border">R$ <?php If($pulsar_comissao >= 0) echo formatNumber($pulsar_comissao); Else echo"0,00";?></td>
					</tr>
...
// 										echo "XXXXXXXX $COMISSAO_INDIO $tribo - ".$row_OBJCONTRATOS['ID_CONTRATO']."<br>";
										$found_tribo = $tribo;
								...
								if(!$find) {
									...
									$contrato_indios_dois .= $row_OBJCROMOS['ID_CONTRATO']." [$double_tribo], ";
								} else {
