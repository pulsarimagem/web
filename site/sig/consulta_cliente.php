...
$isDel =  isset($_GET['del'])?true:false;
if($isDel) { 
	$id = $_GET['id_cliente'];
	//	consultando dinfromacoes do cliente
	$sql = "UPDATE CLIENTES SET STATUS='I' WHERE ID = ".$id;
// 	echo $sql;
	$objRS	= mysql_query($sql, $sig) or die(mysql_error());
	header("location: ".$_SESSION['menu_url']);
}
...
<form name="cliente" action="tool_cliente_gravar.php" method="post">
	<table width="90%">
		...
		<tr></tr>
		<tr>
			<td id="border" colspan="6"><center><font face="Times New Roman" color="#000000"><b><?php echo $isNovo?"Novo Cliente":$row_objRS["FANTASIA"] ?></b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/edit.gif" class="editBtn" border="0" alt="editar cadastro" />&nbsp;<a href="consulta_cliente.php?del=true&id_cliente=<?php echo $isNovo?"":$row_objRS["ID"]?>"><img src="images/del.gif" border="0"  alt="excluir cadastro" /></a></center></td></tr>
		<tr></tr>
		<tr>
