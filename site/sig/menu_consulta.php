...
<?php if($has_deate) {?>
	                <li>
	                    ...
	                    <input name="de" type="text" class="calendar" maxlength="10" onKeyPress="return txtBoxFormat(this, '99/99/9999', event);"/><i style="margin-left: 10px; font-size: 10px; color:#CCCCCC">dd/mm/aaaa</i>
		                <div class="clear"></div>
	                </li>
	            	<li>
	                	<label>Período Final: </label>
	                    <input name="ate" type="text" class="calendar" maxlength="10" onKeyPress="return txtBoxFormat(this, '99/99/9999', event);"/><i style="margin-left: 10px; font-size: 10px; color:#CCCCCC">dd/mm/aaaa</i>
		                <div class="clear"></div>
	                </li>
<?php } ?>
<?php if($has_codigo) {?>
