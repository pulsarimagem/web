...
/**
 * This is the model class for table "Fotos_bkup".
 *
 * The followings are the available columns in table 'Fotos_bkup':
 ...
 */
class FotosBkup extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return FotosBkup the static model class
	 */
