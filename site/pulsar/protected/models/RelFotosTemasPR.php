...
/**
 * This is the model class for table "rel_fotos_temas_PR".
 *
 * The followings are the available columns in table 'rel_fotos_temas_PR':
 * @property integer $id_rel
 * @property integer $id_foto
 * @property integer $id_tema
 */
class RelFotosTemasPR extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RelFotosTemasPR the static model class
	 */
