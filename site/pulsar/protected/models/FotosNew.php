...
/**
 * This is the model class for table "Fotos_new".
 *
 * The followings are the available columns in table 'Fotos_new':
 ...
 */
class FotosNew extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return FotosNew the static model class
	 */
