...
/**
 * This is the model class for table "CLIENTES_BKP".
 *
 * The followings are the available columns in table 'CLIENTES_BKP':
 * @property integer $ID
 ...
 */
class CLIENTESBKP extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CLIENTESBKP the static model class
	 */
