...
/**
 * This is the model class for table "rel_fotos_temas_tmp".
 *
 * The followings are the available columns in table 'rel_fotos_temas_tmp':
 * @property integer $id_rel
 * @property integer $id_foto
 * @property integer $id_tema
 */
class RelFotosTemasTmp extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RelFotosTemasTmp the static model class
	 */
