...
/**
 * This is the model class for table "rel_fotos_pal_ch".
 *
 * The followings are the available columns in table 'rel_fotos_pal_ch':
 * @property integer $id_rel
 * @property integer $id_foto
 * @property integer $id_palavra_chave
 */
class RelFotosPalCh extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RelFotosPalCh the static model class
	 */
