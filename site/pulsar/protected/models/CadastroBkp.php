...
/**
 * This is the model class for table "cadastro_bkp".
 *
 * The followings are the available columns in table 'cadastro_bkp':
 ...
 */
class CadastroBkp extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CadastroBkp the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('limite, id_cliente_sig, id_contato_sig', 'numerical', 'integerOnly'=>true),
			array('id_cadastro, cpf_cnpj', 'length', 'max'=>20),
			array('nome, empresa, endereco, senha', 'length', 'max'=>100),
			array('cargo, cidade, telefone', 'length', 'max'=>50),
			...
			array('id_cadastro, nome, empresa, cargo, cpf_cnpj, endereco, cep, cidade, estado, pais, telefone, email, login, senha, tipo, data_cadastro, temporario, download, limite, idioma, id_cliente_sig, id_contato_sig', 'safe', 'on'=>'search'),
		);
	}
