...
/**
 * This is the model class for table "Fotos_tmp".
 *
 * The followings are the available columns in table 'Fotos_tmp':
 ...
 */
class FotosTmp extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return FotosTmp the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_autor, id_estado, dim_a, dim_b, status', 'numerical', 'integerOnly'=>true),
			...
			array('Id_Foto, tombo, id_autor, data_foto, cidade, id_estado, id_pais, orientacao, assunto_principal, dim_a, dim_b, extra, pal_chave, status', 'safe', 'on'=>'search'),
		);
	}
