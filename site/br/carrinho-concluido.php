<?php
	...
	foreach($_SESSION['produto'] as $id => $quantidade){
		...
		if(isset($_GET['tipopag'])){
			...
			$dt = date("d/m/Y H:i:s");
			$pedido->gravaPedido(array("cpf" => $row_top_login['id_cadastro'], "cod_pedido" => $_SESSION['existPedido'], "valorpedido" => $totalgeral, "data" => $dt,"statustransacao" => "Aguardando pagamento"));
			/////////////////
		}
