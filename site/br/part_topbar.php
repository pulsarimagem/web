...
<!--                  <li class="carrinho"><a href="carrinho.php" title="Carrinho"><span>Meu carrinho</span></a></li> -->
                  <?php if ($logged) { ?>
                  <li class="user-item logado"><!-- <?php echo @$row_top_login['nome'] ?> - --><strong><a href="primeirapagina.php">Minhas pastas</a></strong> - <a href="index.php?logout=true">Logout</a></li>
                  <?php } else { ?>
                  ...
                  <?php } ?>
                  <li class="language">
                    <a class="pt-br" href="../br">Português</a>
                    <a class="en" href="../en">Inglês</a>
                  </li>
                </ul>
              </div>
              <!--					<div class="form">
