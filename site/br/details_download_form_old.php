...
<?php include("../tool_details_download_form_old.php"); ?>
...
<!-- 	                    
 ...
 -->	                    
	                    ...
	                    <select id="tipo_proj" name="tipo_proj" class="uso<?php if($tipo_proj_error) echo " error"?>">
		                  	<option value="">--- Escolha um tipo de projeto ---</option>
<?php 
$last_tipo = "";
while($row_usos = mysql_fetch_array($usos)) { 
?>
		                  	<option value="<?php echo $row_usos['Id']?>"<?php if ($uso == $row_usos['Id']) echo " selected";?>><?php echo $row_usos['tipo']?></option>
<?php 
} 
?>		                  	
	                    </select>
						<input id="tipo_proj_ant" name="tipo_proj_ant" type="hidden" value="<?php echo $row_tipo_proj['id_tipo']; ?>"/>
...
<?php } ?>
							...
							<input name="tiragem" type="hidden" value="<?php echo $_POST['tipo_proj']?>"/>
