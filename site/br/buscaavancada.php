...
$query_paises = "SELECT Fotos.id_pais, nome, nome_en FROM Fotos LEFT JOIN paises ON paises.id_pais = Fotos.id_pais WHERE Fotos.id_pais IS NOT NULL GROUP BY Fotos.id_pais ORDER BY nome ASC";
          ...
          <div class="box">
            <form name="form1" method="get" action="listing.php">
              <ul>
                <li>
                  	<label>Tipo:</label>
                  	<input name="filtro[]" type="checkbox" value="foto" class="radio" checked/><span class="foto">Foto</span>
	            	<input name="filtro[]" type="checkbox" value="video" class="radio" checked/><span class="video">Vídeo</span>
	            	<div class="clear"></div>
                </li>       
                ...
                <li>
                  <label style="padding-top:0; line-height: 1em">Não contendo palavra:</label>
                  <input name="nao_palavra" type="text" class="text" />
                  <div class="clear"></div>
                </li>
                <li>
                  <label>Fração da palavra:</label>
...
<!--                   <input name="ordem" type="radio" value="recente" class="radio" checked/> <p>Mais recentes</p> -->
                  <input name="ordem" type="radio" value="relevancia" class="radio" checked/> <p>Mais recentes</p>
