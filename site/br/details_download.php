...
<?php if($has_hd) { ?>			
            	<h3><a href="details_download_form.php?name=<?php echo $tombos[0]?>&contrato=V&resolucao=HD&<?php echo $download_url_param;?>">HD</a> ou <a href="details_video_form.php?name=<?php echo "/dist/".$tombos[0]."_1280x720"?>&resolucao=SD&<?php echo $download_url_param;?>">SD</a></h3>
<?php } else { ?> 
...
<?php 	} else { ?>
			<div class="tipo-de-download">
            	<h3>Você não pode baixar mais de um vídeo de cada vez.</h3>
            </div>
<?php 	}?>
...
<?php } else { ?>
			<div class="tipo-de-download">
            	<h3>Você não pode baixar fotos e videos ao mesmo tempo!</h3>
            </div>
<?php } ?>
		</div>
	</div>
