<div class="action-image">
  <ul>
    ...
    <li class="trocar-pasta"><a href="#" title="Trocar de pasta">Trocar de pasta</a></li>
    <li class="excluir-pasta"><a href="#" title="Excluir">Excluir</a></li>
    <li class="cotacao"><a href="<?php print $_SESSION['last_detail']; ?>&cotar=true" title="Cotar">Cotar</a></li>
  ...
  <br />
  <ul>
    <li class="meucadastro"><a href="#" title="Meu cadastro">Meu cadastro</a></li>
    <li class="download"><a href="details_download.php?tombo=<?php echo $tombo;?>" title="Histórico de Downloads">Histórico de Downloads</a></li>
  </ul>
</div>
