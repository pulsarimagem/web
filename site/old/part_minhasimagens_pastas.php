<?php include("tool_minhasimagens_pastas.php")?>
...
<?php if($totalRows_pastas == 0) {?>				
					<div class="error-msg">
						Você não adicionou nenhuma imagem ou pasta
					</div>
<?php } else {?>				
...
<?php } 
if($sort == "criacao") { ?> 
									<td><a href="primeirapagina.php?ordem=datacriacao<?php if(!$desc) echo "&rev=";?>">Data de Criação <span><?php if($desc)echo "&#9650;"; else echo "&#9660;";?></span></a></td>
<?php } else {?> 
									<td><a href="primeirapagina.php?ordem=datacriacao">Data de Criação <span>&nbsp;</span></a></td>
<?php } 
if($sort == "edicao") { ?> 
									<td><a href="primeirapagina.php?ordem=dataedicao<?php if(!$desc) echo "&rev=";?>">Última Edição <span><?php if($desc)echo "&#9650;"; else echo "&#9660;";?></span></a></td>
<?php } else {?> 
									<td><a href="primeirapagina.php?ordem=dataedicao">Última Edição <span>&nbsp;</span></a></td>
<?php } ?> 
								</tr>
							</thead>
							<tbody>
