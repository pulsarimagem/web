...
if($row_dados_foto['dim_a']!=NULL &&$row_dados_foto['dim_a']!=0) {
	$detail_dim .= "Dimensões da imagem: ".$row_dados_foto['dim_a']." px X ".$row_dados_foto['dim_b']." px   -   300 DPI. Caso necessite esse arquivo em outras dimensões, <a href=\"contato.php\">entre em contato.</a><br/><br/>";
}
