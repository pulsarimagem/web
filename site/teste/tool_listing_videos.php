...
Fotos_tmp.Id_Foto,   Fotos_tmp.tombo, Fotos_tmp.assunto_principal, Fotos_tmp.orientacao, Fotos_tmp.data_foto, Fotos_tmp.status 
...
"	  	;
	...
	$query_retorno2 = sprintf("
		SELECT tmp13.Id_Foto, tmp13.assunto_principal, tmp13.orientacao, tmp13.tombo, tmp13.data_foto, tmp13.status, Fotos_tmp.extra 
		FROM tmp13  
