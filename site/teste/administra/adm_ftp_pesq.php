...
<?php if (($totalRows_pesquisa > 0)) { // Show if recordset not empty ?>
  <table width="100%" border="1" cellspacing="0" cellpadding="0">
    ...
    <?php do { ?>
      <tr>
        <td class="style3"><a href="adm_ftp_inc3.php?login=<?php echo $row_pesquisa['login']; ?>"><?php echo $row_pesquisa['login']; ?></a></td>
  ...
  <form action="adm_ftp_tmp.php" method="post" name="form9" target="_self" id="form9">
