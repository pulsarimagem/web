...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2") && ($_POST['data'] != "")) {
  $updateSQL = sprintf("UPDATE Fotos SET data_foto=%s WHERE tombo IN (%s)",
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="60" class="style1">Nova data:</td>
