...
<?php }?>
				<label>Descreva os fins para utilização da(s) foto(s)</label>
				<textarea name="descricao" cols="" rows="" <?php if($descricao_error) {?>class="error"<?php } ?>><?php echo $descricao; ?></textarea>
...
<?php do { ?>					
					<li>
						...
						<p class="img">
							<img src="<?php echo "http://www.pulsarimagens.com.br/"; //$homeurl; ?>bancoImagens/<?php echo $row_fotos_pasta['tombo']; ?>p.jpg" alt="<?php echo $row_fotos_pasta['assunto_principal']; ?>" style="max-width:77px; max-height:77px;" />
