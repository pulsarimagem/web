...
$opt_menu = array	("Relatório de Comissões"=>"menu_consulta.php?has_deate=true&has_autores=true&has_luis=true&title=Relatório de Comissões&redirect=relatorio_comissoes.php",
					...
					"Consulta Clientes"=>"menu_consulta.php?has_fantasia=true&has_razao&title=Consulta Clientes&redirect=consulta_contrato_busca.php&cliente=true",
...
function get_tribos() {
	$indios = array("Kalapalo" => 0, "Caingangue" => 0, "Bororo" => 0, "Yanomami" => 0, "Kamayurá" => 0, "Xavante" => 0, "Yawalapiti" => 0, "Guarani" => 0, "Kambeba" => 0, "Kolulu" => 0, "Kaingang" => 0, "Tukano" => 0, "Kayapo" => 0, "Kayapó" => 0);
	return $indios;	
}


function merge_tribos(&$tribos) {
	$same_tribos = array("Kaingang" => "Caingangue", "Kolulu" => "Yanomami", "Kayapo" => "Kayapó");
...
if (isset($_SESSION['MM_Username'])) {
	...
	$query_top_login = sprintf("SELECT * FROM usuarios WHERE login like '%s'", $colname_login);
