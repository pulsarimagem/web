 ...
 */
	...
	$command_set = "exiftool ".$dest_file." -overwrite_original -L -Title=\"".$IPTCtitle."\" -Creator=\"".$IPTCcreator."\" -\"By-lineTitle\"=\"".$IPTCbylinetitle."\" -Description=\"".$IPTCdescription." Local: ".$IPTClocation." Data: ".$IPTCdatecreated2." Tombo:  ".$IPTCbylinetitle." Autor: ".$IPTCcreator."\" -Location=\"".$IPTClocation."\" -XMP:City=\"".$IPTCcity."\" -XMP:State=\"".$IPTCstate."\" -XMP:Country=\"".$IPTCcountry."\" -CreateDate=\"".$IPTCdatecreated."\" -Subject=\"".$IPTCkeywords."\" -Rights=\"".$IPTCcopyright."\" -Copyright=\"".$IPTCcopyright."\" -\"CopyrightFlag\"=true -CopyrightNotice=\"".$IPTCcopyright."\"";
	$command_set2 = "exiftool ".$dest_file." -overwrite_original -L -\"Caption-Abstract\"=\"".$IPTCdescription." Local: ".$IPTClocation." Data: ".$IPTCdatecreated2." Tombo:  ".$IPTCbylinetitle." Autor: ".$IPTCcreator."\" -Credit=\"".$IPTCcreator."\" -\"Writer-Editor\"=\"".$IPTCcreator."\"";
...
echo "1  ".shell_exec("ls -l /usr/bin/exif*");
echo "2  ".shell_exec("/usr/bin/exiftool -ver");
