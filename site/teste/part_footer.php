...
<div class="socialbar size960">
	<div class="social">
		<a href="http://www.facebook.com/profile.php?id=100001082880521&ref=profile#!/profile.php?id=100001082880521&ref=profile" class="facebook" target="_blank"></a>
...
<div class="map size960">
	...
	<div class="col">
		<dl>
			...
			<dd><a href="fotografos.php">Fotógrafos</a></dd>
			<dd><a href="primeirapagina.php">Minha conta</a></dd>
            <dd><a href="solicitarcotacao.php">Cotação</a></dd>
			<dd><a href="cadastro.php">Cadastro</a></dd>
			<dd><a href="buscaavancada.php">Busca avançada</a></dd>
		</dl>
	</div>
	<div class="col">
		<dl>
			<dt>Navegação Auxiliar</dt>
            <dd><a href="comofunciona.php">Como Funciona?</a></dd>
			<dd><a href="faq.php">Dúvidas</a></dd>
...
<div class="footer size960">
	<p>® Pulsar Imagens 2011 - Todos os direitos reservados.</p>
	<span class="br"></span>
	<div class="clear"></div>
</div>
<?php 
