...
<?php 
include("tool_dadoscadastrais.php");
?>
...
<?php include("part_cadastro_left.php");?>
	...
	<div class="grid-right">
		<div class="dadoscadastrais">
			...
			<p class="p">Preencha os campos abaixo para realizar a atualização dos seus dados cadastrais. </p>
...
<!-- 						<li>
						...
						<li style="text-align: center;">
							...
							<input name="action" type="submit" class="button" value="Confirmar Alterações" />
						</li>
					</ul>
				</div>
			</form>
