...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
              ...
              <td width="96%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td><table width="100%" height="50" border="0" cellpadding="10" cellspacing="10">
                    <tr>
                      <td><img src="http://new.pulsarimagens.com.br/images/pulsarimagens.png" alt="logo" width="216" height="34" /></td>
                      <!-- Logo -->
                ...
                <tr>
                  <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="75%"><p style="font-family:Arial, Helvetica, sans-serif; font-size: 24px; text-align:left; margin: 0; color:#ff9900; font-weight: bold; padding-left: 30px; padding-top: 20px; padding-bottom: 2px; letter-spacing: 2px;">Seus dados para login:</p></td>
                      </tr>
                    <tr>
  ...
  <tr>
    <td height="1" bgcolor="#999999"></td>
                    ...
                    <tr>
                      <td><p style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; text-align:left; margin: 0; padding-left:30px; color:#000000; font-weight: normal;">Ola '. $row_email['nome'] .', <br>
                        <br>
                        a sua senha para acesso ao site &eacute;:<br>
                        <strong>Login:</strong> '. $row_email['login'] .'<br>
                        <strong>Senha:</strong> '. $row_email['senha'] .'<br>
                        <br>
                        Estamos &agrave; disposi&ccedil;&atilde;o para auxili&aacute;-lo. <br>
                        <br>
                        Obrigado. <br>
                        <br>
