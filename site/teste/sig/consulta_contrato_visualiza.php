...
?>
		<tr>
			<td id="border" colspan="4"><center><font face="Times New Roman" color="#000000"><b>NOTA Nº <input type="text" name="nota" size="25" value="<?php echo  $nota ?>">&nbsp;-&nbsp;DATA PAGAMENTO: <input type="text" name="data_nota" size="25" value="<?php echo  $data_nota ?>"></b></font></center></td>
		</tr>
<?php	
	}
	else {
...
<table width="95%">
	<tr>
		...
		<td id="border" width="10%"><center><font face="Times New Roman" color="#000000"><b>REUSO</b></font></center></td>
	</tr>
...
<?php If (isset($_GET['editaCromo']) && $_GET['editaCromo'] == "sim" && !$isBaixado) { ?>
			...
			<td id="border"><input type="checkbox" name="reuso[]" value="<?php echo $row_objRS5['ID']?>" id="chk_<?php echo $contador?>" class="reuso unbind_unload" <?php echo $row_objRS5['reuso']!=0?"checked":""?>/></td>
...
<?php } else { ?>
			...
			<td id="border"><input type="checkbox" name="reuso[]" value="<?php echo $row_objRS5['ID']?>" id="chk_<?php echo $contador?>" class="reuso" <?php echo $row_objRS5['reuso']!=0?"checked":""?> disabled/></td>
<?php 	if(isset($_GET['editaCromo']) && $_GET['editaCromo'] == "sim" && $isBaixado) {?>
