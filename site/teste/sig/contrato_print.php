...
<table width="100%">
	<tr><td align="center">______________________________</td><td align="center"><?php if (ord($row_objContrDesc['assinatura']) == 1 || ord($row_objContrDesc['assinatura']) == 49) { ?><img src="images/Assinatura.JPG" /><?php } else { ?>______________________________<?php } ?></td></tr>
	<tr><td align="center"><b><?php echo $razao_social ?></b></td><td align="center"><b>Pulsar Imagens LTDA.</b></td></tr>
</table>
