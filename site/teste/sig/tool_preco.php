...
If (isset($_GET["inclui"])) {
    ...
    If ( $_POST["txtvalor"] != "" ) {        
       ...
       $sqlInclui = "insert into USO(id_tipo,id_utilizacao,id_formato,id_distribuicao,id_periodicidade,id_tamanho,id_descricao,valor,contrato)values(" . $_POST["ddltipo"] . "," . $_POST["ddlutilizacao"] . "," . $_POST["ddlformato"] . "," . $_POST["ddldistribuicao"] . "," . $_POST["ddlperiodicidade"] . "," . $_POST["ddltamanho"] . "," . $_POST["ddldescricao"] . ",'".$_POST["contrato"]."')";
    }
...
$sqlTotal = "select 
    			uso.Id, uso.contrato, tipo_br as tipo, utilizacao.subtipo_br as utilizacao, formato_br as formato, distribuicao_br as distribuicao, periodicidade_br as periodicidade, tamanho.descricao_br as tamanho, valor, tamanho.descricao_br as descricao 
    		from 
    			USO as uso
