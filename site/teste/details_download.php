...
<?php 	if(count($tombos) == 1) { 
			...
			<div class="tipo-de-download">
            	<h3><a href="details_video_form.php?tamanho=HD&<?php echo $download_url_param;?>">HD</a> ou <a href="details_video_form.php?tamanho=SD&<?php echo $layout_url_param;?>">SD</a></h3>
            </div>
<?php 		} else { ?>
			<div class="tipo-de-download">
