...
<?php foreach ($thumbs as $thumb) {?>	           	
	               	<img src="<?php echo $cloud_server?>Videos/thumbs/<?php echo $thumb?>" /> <!-- onclick="MM_openBrWindow('http://www.pulsarimagens.com.br/bancoImagens/<?php echo $_GET['tombo']; ?>.jpg','','resizable=yes,width=550,height=550')"  -->
<?php }?>
