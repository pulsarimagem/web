...
<?php //} ?>
        ...
        <div class="action-image">
          <ul>
            ...
            <li class="minhas-pastas"><a href="details.php?tombo=<?php echo $tombo;?>&search=<?php echo $search;?>&total_foto=<?php echo $total_foto;?>&ordem_foto=<?php echo $ordem_foto;?>&addimg=true" title="Adicionar às Minhas Pastas">Adicionar às Minhas Pastas</a></li>
...
else if($row_dados_foto['direito_img'] == 2) echo "OBS: USO DE IMAGEM AUTORIZADO - ACRÉSCIMO DE 100% SOBRE O VALOR DE TABELA"; 
?>
				</div>
