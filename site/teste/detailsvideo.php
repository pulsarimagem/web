...
<?php include("part_grid_left.php")?>
	...
	<div class="grid-right">
		...
		<div class="details">
			<a href="<?php echo $_SESSION['last_search'];?>" class="voltar">« Voltar</a>
            <br/>
			<br/>
...
<?php } ?>					
					...
					<div class="video" id="mp<?php echo $row_dados_foto['tombo']; ?>" style="width:640px;height:320px; position:relative"></div>
