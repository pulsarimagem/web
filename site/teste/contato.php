...
<?php include("part_grid_left.php")?>
	...
	<div class="grid-right">
		<div class="contato">
			...
			<p class="p">Preencha os campos abaixo para entrar em contato conosco. Fique a vontade para enviar suas dúvidas, sugestões e críticas. Sua opinião é muito importante para nós. </p>
					...
					<ul>
						...
						<li>
							...
							<select class="select" name="setor">
								<option value="pulsar">Dúvidas Gerais</option>
